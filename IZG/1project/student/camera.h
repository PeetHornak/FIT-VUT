 ...
 *
 * \image html images/frustum.svg "General perspective frustum"
 *
 ...
 */
void frustum_Mat4(Mat4 *const output, float const left, float const right,
                  float const bottom, float const top, float const near,
                  float const far);
 ...
 */
void perspective_Mat4(Mat4 *const output, float const fovy, float const aspect,
                      float const near, float const far);

/**
 * @brief This function computes view matrix of orbit camera manipulator.
 *
 * \image html images/orbit_camera.svg "orbit camera"
 *
 ...
 */
void cpu_computeOrbitCamera(Mat4 *const viewMatrix, float const angleX,
                            float const angleY, float const distance);
 ...
 */
void cpu_getCameraPositionFromViewMatrix(Vec3 *const       cameraPosition,
