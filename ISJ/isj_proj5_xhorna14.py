...
def gen_quiz(qpool, *args, altcodes=('A', 'B', 'C', 'D', 'E', 'F'), quiz=None):
    """
    ...
    for i in args:
        try:
            ...
            msg = str(e)
            print("Ignoring index {} - {}".format(i, msg))
            continue
        answers = ["{}: {}".format(code, answer) for code, answer in zip(altcodes, pool[1])]
        quiz.append((pool[0], answers))
    return quiz
